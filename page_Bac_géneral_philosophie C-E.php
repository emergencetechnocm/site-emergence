...
margin-left:0px; margin-right:0px; padding:50px; border-radius: 5px;float: left; min-height:150vh" >
              ...
              <div id="contenu_matière"> 
                <h4 class="grand_titre" style=" text-align: center; color: white; background-color: black ; border-radius:5px;"> les sujets de philosophie au baccalauréat C et E </h4>
              </div>
        
            
              
                 <ul>
                     <li><p class="cours">  <a href="download/philosophie C-E/philosophie bacc C-E 2013.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> philosophie au baccalauréat C et E session 2013 </a></p></li>
