...
margin-left:0px; margin-right:0px; padding:50px; border-radius: 5px;float: left; min-height:150vh" >
              ...
              <div id="contenu_matière"> 
              	<h4 class="grand_titre" style=" text-align: center; color: white; background-color: black ; border-radius:5px;"> les sujets d'informatique au probatoire C-D et E</h4>
              </div>
   	    
            
              
                 <ul>
                     <li><p class="cours">  <a href="download/probatoire_géneral_informatique C-D et E/épreuve d'informatique probatoire C-D et E session 2020.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> épreuve d'informatique probatoire C-D et E session 2020 </a></p></li>
