                ...
                <h4 class="grand_titre" style=" text-align: center; color: white; background-color: black ; border-radius:5px;"> les sujets de mathematique au baccalauréat D</h4>
                 ...
                 <ul>
                    ...
                    <ul>
                     ...
                     <li><p class="cours">  <a href="download/math bacc générale D/math bacc D 2000.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> mathematique au baccalauréat D session 2000 </a></p></li>
