  ...
  if(lancer=="oui")
   ...
   <div class="col-12 col-md-6 my-3 pl-5" style=" background-image:url(images/coeur.png); font-family: 'Oswald', sans-serif;"> 
            <form id="contact" name="contact" method="post" action="messagerie.php">
              ...
              <input type="text" name="msg_mail" id="msg_mail" maxlength="100" />
              </div>
              <div class="div_txt_form">
              Sujet :
              </div>
              <div class="div_input_form">
              <input type="text" name="msg_sujet" id="msg_sujet" maxlength="100" />  
              </div>
              <div class="div_msg">
              <br /><strong>Votre message :<strong><br />
              <textarea id="msg_contenu" name="msg_contenu" cols="40" rows="5" class="zone_msg"></textarea> 
              </div>
              <div class="div_txt_form">
              &nbsp;
              </div>
...
<div class="col-12 col-md-6 pl-5 pr-5 pt-2  my-3" style="background-image:url(images/coeur.png);  font-family: 'Cuprum', sans-serif; margin-left: 100px; " >


       <div class="div_msg" style="text-align: center;">
          <img id="mem_image" /><br />
          <strong>Code anti-spam :<strong><br />    
          <input type="text" name="msg_code" id="msg_code" maxlength="50" class="input_form" />   
          <input type="text" name="mem_code" id="mem_code" maxlength="50" class="input_form" style="visibility:hidden;" />
          </div>
          <br />
