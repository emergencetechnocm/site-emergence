    ...
    <div class="col-12 col-md-9" style="background-image:url(images/coeur); width: 69.2%; border:groove; 
      margin-left:0px; margin-right:0px; padding:50px; border-radius: 5px;float: left; min-height:150vh" >
              ...
              <div id="contenu_matière"> 
              	<h4 class="grand_titre" style="text-align: center; color: white; background-color: black ; border-radius:5px;"> les sujets de français au baccalauréat F1-2-3-4-5-7-8-CI </h4>
              </div>
              
                 <ul>
                     

                  <li><p class="cours">  <a href="download/Francais BACC F/Francais BACC F session 2017.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  Francais BACC F 2017 </a></p></li>
