    ...
    <div class="col-12 col-md-9" style="background-image:url(images/coeur); width: 69.2%; border:groove; 
      margin-left:0px; margin-right:0px; padding:50px; border-radius: 5px;float: left; min-height:150vh" >
              ...
              <div id="contenu_matière"> 
              	<h4 class="grand_titre" style="text-align: center; color: white; background-color: black ; border-radius:5px;"> les sujets d'EPS au CAP </h4>
              </div>
   	    
            
              
                 <ul>
                     <li><p class="cours">  <a href="download/EPS CAP/EPS CAP session 2000.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> EPS CAP session 2000 </a></p></li>
