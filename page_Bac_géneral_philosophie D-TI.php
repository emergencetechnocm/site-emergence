...
margin-left:0px; margin-right:0px; padding:50px; border-radius: 5px;float: left; min-height:150vh" >
              ...
              <div id="contenu_matière"> 
                <h4 class="grand_titre" style=" text-align: center; color: white; background-color: black ; border-radius:5px;"> les sujets de philosophie au baccalauréat D et TI </h4>
              </div>
        
            
              
                 <ul>
                     <li><p class="cours">  <a href="download/philosophie D-TI/philosophie bacc D-TI 2019.pdf"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> philosophie au baccalauréat D et TI session 2019 </a></p></li>
